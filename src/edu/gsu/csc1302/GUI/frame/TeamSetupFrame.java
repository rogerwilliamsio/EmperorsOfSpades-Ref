...
public class TeamSetupFrame extends SpadesHeaderFrame {
    ...
    public TeamSetupFrame() {
        super("Team Setup");
        this.setPreferredSize(new Dimension(SpadesGUI.DEFAULT_FRAME_WIDTH, SpadesGUI.DEFAULT_FRAME_HEIGHT));
    ...
    private JPanel getDisplayBottomMenusButtons() {
        ...
        final SpadesButton proceedButton = new SpadesButton("Let's GO!!!", Color.YELLOW, Color.BLACK);
    ...
    private JPanel getDisplayOfTeamsInfo() {
        ...
        //      TEAM ONE
//      @todo: will be replaced with a loop when list of teams is passed in the game engine object
...
//        @todo: remove these dummy players
        ...
        JLabel consolePlayer = new JLabel(GUIHelper.getPlayerImg("console", false));
        ...
        SpadesHeading yourTeamLbl = new SpadesHeading("You are on this team.", 15, Color.YELLOW, SwingConstants.CENTER);
